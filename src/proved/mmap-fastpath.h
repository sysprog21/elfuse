 ...
 * here. That rules out a function reporting a fit that ends up past limit.
 * Chasing the converse would mean re-deriving align_up_ok's own arithmetic in
 * this contract instead of resting on its proof.
 */
/*@
 ...
 * out under both alt-ergo and z3 at 90s, ten times FRAMAC_TIMEOUT, while the
 * plain upper-bound invariant below proves in milliseconds. The upper bound is
 * also the only property arena_size's sizing math actually needs.
 */
/*@
